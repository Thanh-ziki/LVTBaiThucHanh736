...
namespace MvcMovie.Controllers
{
    public class AnimalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaBan,KhachHang,NgayBan")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaBan,KhachHang,NgayBan")] Animal animal)
        {
            if (id != animal.MaBan)
            {
                return NotFound();
        ...
        {
          return (_context.Animal?.Any(e => e.MaBan == id)).GetValueOrDefault();
        }
    }
}
